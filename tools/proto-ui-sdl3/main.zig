...
pub fn main(minimal: std.process.Init.Minimal) !void {
    ...
    var scene = switch (config.mode) {
        ...
        .emacs_pointer_selection => try runEmacsEpxlSession(gpa, io, &config, 1),
        .frame_lifecycle => {
