        ...
        if (snapshot) |bytes| {
            ...
            if (!first_snapshot_rendered) {
                ...
                if (std.c.getenv("TPE_INPUT_SMOKE") != null) {
                    ...
                    if (!SDL_PushEvent(&mouse)) return sdlFail("SDL_PushEvent");
                    mouse = mouseButtonEvent(17, 21, input_policy.SDL_EVENT_MOUSE_BUTTON_DOWN, true);
            ...
            if (std.c.getenv("TPE_VISIBILITY_SMOKE") != null and
                snapshot_rows > 0 and !smoke_visibility_requested)
            {
                smoke_visibility_requested = true;
            ...
            if (std.c.getenv("TPE_INPUT_SMOKE") != null and
                snapshot_rows > 24 and !smoke_close_resent)
            {
                smoke_close_resent = true;
                var close = windowEvent(
                    input_policy.SDL_EVENT_WINDOW_CLOSE_REQUESTED,
                    SDL_GetWindowID(window),
                    0,
                    0,
