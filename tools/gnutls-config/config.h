...
/* The soname of brotlidec library */
/* #undef BROTLIDEC_LIBRARY_SONAME */

/* The soname of brotlienc library */
/* #undef BROTLIENC_LIBRARY_SONAME */
...
/* use the given certificate blocklist file */
/* #undef DEFAULT_BLOCKLIST_FILE */
...
/* enable crypto-auditing trace */
/* #undef ENABLE_CRYPTO_AUDITING */
...
#define GNULIB_IOCTL IN_GNUTLS_GNULIB_TESTS
...
#define GNULIB_LOCALEDIR "/tmp/ref-prefix/share/locale"
...
/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module recv shall be considered present. */
#define GNULIB_RECV 1

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module recvfrom shall be considered present. */
#define GNULIB_RECVFROM 1
...
/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module send shall be considered present. */
#define GNULIB_SEND 1

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module sendto shall be considered present. */
#define GNULIB_SENDTO 1

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module setsockopt shall be considered present. */
#define GNULIB_SETSOCKOPT 1

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module shutdown shall be considered present. */
#define GNULIB_SHUTDOWN 1
...
/* Define to 1 if you have the 'Esys_SetCryptoCallbacks' function. */
/* #undef HAVE_ESYS_SETCRYPTOCALLBACKS */
...
/* Define to 1 if you have the 'lc_dilithium_pk_from_sk' function. */
/* #undef HAVE_LC_DILITHIUM_PK_FROM_SK */

/* Define if your <locale.h> file defines LC_MESSAGES. */
#define HAVE_LC_MESSAGES 1

/* Have leancrypto */
/* #undef HAVE_LEANCRYPTO */
...
/* Define to 1 if you have the <sys/ktls.h> header file. */
/* #undef HAVE_SYS_KTLS_H */
...
/* Define if ZLIB compression is enabled. */
/* #undef HAVE_ZLIB */
...
/* The soname of m library */
/* #undef M_LIBRARY_SONAME */
...
#define PACKAGE_STRING "GnuTLS 3.8.13"
...
#define TLS_FEATURES "ssl2-compat alpn psk dhe ecdhe auth-anon"

/* the location of the trousers library */
#define TROUSERS_LIB ""

/* The soname of tss2-esys library */
/* #undef TSS2_ESYS_LIBRARY_SONAME */

/* The soname of tss2-mu library */
/* #undef TSS2_MU_LIBRARY_SONAME */

/* The soname of tss2-tctildr library */
/* #undef TSS2_TCTILDR_LIBRARY_SONAME */
...
/* The soname of zstd library */
/* #undef ZSTD_LIBRARY_SONAME */

/* The soname of z library */
/* #undef Z_LIBRARY_SONAME */
...
/* Work around build failure on mingw caused by mis-interactions
 * between 'close' and 'fchdir' Gnulib modules through dependencies,
 * suggested in:
 * <https://lists.gnu.org/archive/html/bug-gnulib/2024-12/msg00179.html>
 */
#ifdef GNUTLS_BUILDING_LIB
