...
| `session` module | Standard EUP setup/control codecs, setup state machine, Scene control integration, and EPXL suspend/resume live evidence | Implemented as bounded protocol preparation; full runtime control ownership remains pending |
