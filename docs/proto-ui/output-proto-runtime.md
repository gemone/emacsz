...
| `runtime_bridge` module | Drive the pure host ABI both directions: bounded EUP frames/debug runs plus input deliver/result/completion | Fake-host unit and SDL3 presentation conformance implemented; no Emacs host, transport, or registration |
