...
| `proto-ui-protocol-coverage` step | Audit every assigned EUP message ID against its implementation status | Implemented; 58 codecs implemented, 3 partial, and 103 planned |
