...
| `runtime_bridge` module | Drive the pure host ABI in both directions: frames, runs, input lifecycle, and visibility/focus state | Fake-host unit and SDL3 presentation conformance implemented; no Emacs host, transport, or registration |
