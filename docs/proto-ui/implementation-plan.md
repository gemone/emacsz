...
| Protocol coverage manifest | Implemented for all 164 assigned EUP IDs: 87 implemented codecs, 3 partial, and 74 planned; prevents an unclassified or overclaimed protocol table |
...
current counts are 87 implemented codecs, 3 partial, and 74 planned.
