...
| Protocol coverage manifest | Implemented for all 164 assigned EUP IDs: 66 implemented codecs, 3 partial, and 95 planned; prevents an unclassified or overclaimed protocol table |
