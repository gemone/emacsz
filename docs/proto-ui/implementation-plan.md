...
| Protocol coverage manifest | Implemented for all 164 assigned EUP IDs: 97 implemented codecs, 3 partial, and 64 planned; prevents an unclassified or overclaimed protocol table |
...
current counts are 97 implemented codecs, 3 partial, and 64 planned.
