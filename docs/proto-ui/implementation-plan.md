...
| Protocol coverage manifest | Implemented for all 164 assigned EUP IDs: 90 implemented codecs, 3 partial, and 71 planned; prevents an unclassified or overclaimed protocol table |
...
current counts are 90 implemented codecs, 3 partial, and 71 planned.
