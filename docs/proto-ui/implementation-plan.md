...
| Protocol coverage manifest | Implemented for all 164 assigned EUP IDs: 54 implemented codecs, 3 partial, 107 planned; prevents an unclassified or overclaimed protocol table |
...
counts are 54 implemented codecs, 3 partial, and 107 planned.
