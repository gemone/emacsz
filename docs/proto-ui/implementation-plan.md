...
| Protocol coverage manifest | Implemented for all 164 assigned EUP IDs: 85 implemented codecs, 3 partial, and 76 planned; prevents an unclassified or overclaimed protocol table |
...
current counts are 85 implemented codecs, 3 partial, and 76 planned.
