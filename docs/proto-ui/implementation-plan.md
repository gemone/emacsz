...
| Protocol coverage manifest | Implemented for all 164 assigned EUP IDs: 101 implemented codecs, 3 partial, and 60 planned; prevents an unclassified or overclaimed protocol table |
...
current counts are 101 implemented codecs, 3 partial, and 60 planned.
