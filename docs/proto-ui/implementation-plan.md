...
| Protocol coverage manifest | Implemented for all 164 assigned EUP IDs: 35 implemented codecs, 3 partial, 126 planned; prevents an unclassified or overclaimed protocol table |
...
counts are 35 implemented codecs, 3 partial, and 126 planned.
