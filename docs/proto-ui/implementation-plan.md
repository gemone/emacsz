...
| P12-prep EUP session control | Implemented all eight standard-control codecs, Scene integration, and EPXL suspend/resume/liveness/error/close evidence; automatic PONG and VERSION_MISMATCH transport remain pending |
...
recovery, and clean closed state.  Standard-control smoke requires
