...
| Protocol coverage manifest | Implemented for all 164 assigned EUP IDs: 49 implemented codecs, 3 partial, 112 planned; prevents an unclassified or overclaimed protocol table |
...
counts are 49 implemented codecs, 3 partial, and 112 planned.
