...
| Window resize | Negotiated SDL resize intent applies through public Emacs `set-frame-size` with deterministic publisher acknowledgement | Exact WM geometry, close/move/fullscreen/maximize/minimize/restore runtime, and multi-frame control remain pending |
