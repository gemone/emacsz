...
| P18-prep. Explicit damage array | Bounded `DAMAGE_RECTS` codec, active-frame validation, atomic Scene replacement, bridge emission, and clipped retained-target present smoke | Redisplay-owned incremental damage and dirty-texture upload still require R8 |
