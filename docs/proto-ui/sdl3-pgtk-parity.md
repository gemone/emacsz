...
| P18-prep. Explicit damage array | Bounded `DAMAGE_RECTS` codec, active-frame validation, atomic Scene replacement, and bridge emission in SDL smoke | Redisplay-owned incremental damage and partial present still require R8 |
