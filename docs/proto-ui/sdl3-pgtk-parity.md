...
| P20-prep. Scroll-copy policy | A bounded full-window-width vertical `SCROLL_RUN` is validated and planned with overlap/upload metrics | Actual SDL retained-frame copy and redisplay-owned scroll semantics still require R8 |
