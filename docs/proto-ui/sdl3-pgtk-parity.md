...
| P15-prep. Terminal runtime service | Host terminal create/activate/drain/delete callbacks drive a bounded no-reuse registry with drain retry and rollback-pending cleanup | `terminal_service` unit suite; R7 approval and real Emacs host still required |
