...
|---|---|---|---|
| Protocol coverage | All 164 assigned EUP IDs are classified in a deterministic manifest: 61 implemented codecs, 3 partial, and 100 planned; no unassigned or unclassified ID | Production implementation of the 100 planned IDs |
