...
|---|---|---|---|
| Protocol coverage | All 164 assigned EUP IDs are classified in a deterministic manifest: 32 implemented codecs, 3 partial, and 129 planned; no unassigned or unclassified ID | Production implementation of the 132 planned IDs |
