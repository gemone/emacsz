...
|---|---|---|---|
| Protocol coverage | All 164 assigned EUP IDs are classified in a deterministic manifest: 56 implemented codecs, 3 partial, and 105 planned; no unassigned or unclassified ID | Production implementation of the 105 planned IDs |
