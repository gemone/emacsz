...
|---|---|---|---|
| Protocol coverage | All 164 assigned EUP IDs are classified in a deterministic manifest: 50 implemented codecs, 3 partial, and 111 planned; no unassigned or unclassified ID | Production implementation of the 111 planned IDs |
