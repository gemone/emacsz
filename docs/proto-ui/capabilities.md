...
|---|---|---|---|
| Protocol coverage | All 164 assigned EUP IDs are classified in a deterministic manifest: 57 implemented codecs, 3 partial, and 104 planned; no unassigned or unclassified ID | Production implementation of the 104 planned IDs |
