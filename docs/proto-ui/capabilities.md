...
|---|---|---|---|
| Protocol coverage | All 164 assigned EUP IDs are classified in a deterministic manifest: 38 implemented codecs, 3 partial, and 123 planned; no unassigned or unclassified ID | Production implementation of the 126 planned IDs |
