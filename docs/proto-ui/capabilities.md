...
|---|---|---|---|
| Protocol coverage | All 164 assigned EUP IDs are classified in a deterministic manifest: 58 implemented codecs, 3 partial, and 103 planned; no unassigned or unclassified ID | Production implementation of the 103 planned IDs |
