...
|---|---|---|---|
| Protocol coverage | All 164 assigned EUP IDs are classified in a deterministic manifest: 66 implemented codecs, 3 partial, and 95 planned; no unassigned or unclassified ID | Production implementation of the 95 planned IDs |
