...
| Input | Bounded ASCII insert/delete, negotiated bounded UTF-8 text, arrows, Ctrl+C/Ctrl+V, left pointer sessions, vertical wheel | Full keymaps, IME, shaped Unicode rendering, focus, selection drag, pixel/horizontal scroll | `sdl3-input-translate-smoke`, `sdl3-epxl-input-smoke`, `sdl3-epxl-unicode-input-smoke`, `sdl3-epxl-edit-smoke`, `sdl3-pointer-smoke`, `sdl3-wheel-smoke` |
