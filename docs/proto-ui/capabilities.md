...
|---|---|---|---|
| Protocol coverage | All 164 assigned EUP IDs are classified in a deterministic manifest: 37 implemented codecs, 3 partial, and 124 planned; no unassigned or unclassified ID | Production implementation of the 127 planned IDs |
