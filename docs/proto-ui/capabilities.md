...
|---|---|---|---|
| Protocol coverage | All 164 assigned EUP IDs are classified in a deterministic manifest: 62 implemented codecs, 3 partial, and 99 planned; no unassigned or unclassified ID | Production implementation of the 99 planned IDs |
