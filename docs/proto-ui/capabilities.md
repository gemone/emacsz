...
| Scroll optimization | P1 | Degraded | Bounded full-width vertical `SCROLL_RUN` codec and copy-plan metrics; actual SDL scroll-copy and redisplay-owned scroll semantics pending |
...
|---|---|---|---|
| Protocol coverage | All 164 assigned EUP IDs are classified in a deterministic manifest: 63 implemented codecs, 3 partial, and 98 planned; no unassigned or unclassified ID | Production implementation of the 98 planned IDs |
