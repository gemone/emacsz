...
|---|---|---|---|
| Protocol coverage | All 164 assigned EUP IDs are classified in a deterministic manifest: 65 implemented codecs, 3 partial, and 96 planned; no unassigned or unclassified ID | Production implementation of the 96 planned IDs |
