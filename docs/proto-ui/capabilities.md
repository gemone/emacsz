...
|---|---|---|---|
| Protocol coverage | All 164 assigned EUP IDs are classified in a deterministic manifest: 67 implemented codecs, 3 partial, and 94 planned; no unassigned or unclassified ID | Production implementation of the 94 planned IDs |
