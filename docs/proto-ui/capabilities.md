...
| Desktop | Bounded UTF-8 clipboard paste/copy, with Unicode gated by negotiated `clipboard.text_unicode`; bounded DND wire codecs only | MIME, PRIMARY/SECONDARY selection semantics, platform DND, dialogs, menus, scrollbars | `sdl3-clipboard-smoke`, `sdl3-clipboard-unicode-smoke`, `sdl3-emacs-copy-smoke` |
