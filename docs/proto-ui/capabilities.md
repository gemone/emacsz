...
|---|---|---|---|
| Protocol coverage | All 164 assigned EUP IDs are classified in a deterministic manifest: 64 implemented codecs, 3 partial, and 97 planned; no unassigned or unclassified ID | Production implementation of the 97 planned IDs |
