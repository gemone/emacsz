...
| Wheel scroll | P0 | Degraded | Bounded whole-line vertical and horizontal ticks; TPE carries signed high-resolution X/Y centi-unit deltas in the standard wheel-event `arg` (`proto-ui-tpe-input`); pixel-scroll command integration, momentum, page units, and smooth scrolling pending |
