...
pub const Feature = enum {
    ...
    window_zones_v1,
    window_position_v1,
    window_mode_line_bounded_v1,
    window_header_line_bounded_v1,
    window_tab_line_bounded_v1,
    resource_icon_standalone_v1,
    ime_context_lifecycle_v1,
    ime_policy_surrounding_v1,
    ime_reverse_wire_v1,
    ...
    widget_tooltip_bounded_v1,
    widget_menu_model_v1,
    ...
    widget_toolbar_patch_v1,
    widget_dialog_model_v1,
    widget_dialog_result_v1,
    frame_output_proto,
    frame_patch_v1,
    frame_snapshot_core_v1,
    frame_lifecycle,
    ...
    resource_image_v1,
    glyph_atlas_v1,
    shaped_atlas_glyph_run_v3,
    runtime_shaped_run_capture_v1,
    atlas_glyph_render_v1,
    atlas_texture_cache_v1,
    ...
    runtime_face_capture_v1,
    runtime_font_capture_v1,
    runtime_image_capture_v1,
    ...
    pub fn name(self: Feature) []const u8 {
        return switch (self) {
            ...
            .platform_dpi_events => "platform.dpi_events",
            ...
            .render_unicode_text_v1 => "render.unicode_text_v1",
            ...
            .window_mode_line_bounded_v1 => "window.mode_line_bounded_v1",
            .window_header_line_bounded_v1 => "window.header_line_bounded_v1",
            .window_tab_line_bounded_v1 => "window.tab_line_bounded_v1",
            .resource_icon_standalone_v1 => "resource.icon_standalone_v1",
            .ime_context_lifecycle_v1 => "input.ime_context_lifecycle_v1",
            .ime_policy_surrounding_v1 => "input.ime_policy_surrounding_v1",
            .ime_reverse_wire_v1 => "input.ime_reverse_wire_v1",
            ...
            .widget_tooltip_bounded_v1 => "widget.tooltip_bounded_v1",
            .widget_menu_model_v1 => "widget.menu_model_v1",
            ...
            .widget_toolbar_patch_v1 => "widget.toolbar_patch_v1",
            .widget_dialog_model_v1 => "widget.dialog_model_v1",
            .widget_dialog_result_v1 => "widget.dialog_result_v1",
            .frame_output_proto => "frame.output_proto",
            .frame_patch_v1 => "frame.patch_v1",
            .frame_snapshot_core_v1 => "frame.snapshot_core_v1",
            ...
            .glyph_atlas_v1 => "resource.glyph_atlas_v1",
            .shaped_atlas_glyph_run_v3 => "render.shaped_atlas_glyph_run_v3",
            .runtime_shaped_run_capture_v1 => "runtime.shaped_run_capture_v1",
            .atlas_glyph_render_v1 => "render.atlas_glyph_v1",
            .atlas_texture_cache_v1 => "render.atlas_texture_cache_v1",
            ...
            .runtime_face_capture_v1 => "runtime.face_capture_v1",
            .runtime_font_capture_v1 => "runtime.font_capture_v1",
            .runtime_image_capture_v1 => "runtime.image_capture_v1",
    ...
    pub fn negotiable(self: Feature) bool {
        return switch (self) {
            ...
            .runtime_face_capture_v1 => false,
            .runtime_font_capture_v1 => false,
            .runtime_image_capture_v1 => false,
            .runtime_shaped_run_capture_v1 => false,
...
pub const feature_descriptors = [_]FeatureDescriptor{
    ...
    .{ .feature = .platform_focus_window_events, .status = .degraded, .evidence = "sdl3-focus-window-smoke; real SDL focus gained/lost updates a Proto-UI Emacs frame (proto-ui-tpe-frame-focus)" },
    .{ .feature = .platform_monitor_events, .status = .degraded, .evidence = "sdl3-monitor-change-smoke negotiated monitor transport" },
    .{ .feature = .platform_dpi_events, .status = .degraded, .evidence = "sdl3-monitor-change-smoke negotiated DPI transport" },
    ...
    .{ .feature = .frame_visibility_focus_contract, .status = .degraded, .evidence = "proto-ui-unit; real SDL minimize/restore maps to iconify-frame/make-frame-visible and restores frame-visible-p=t (proto-ui-tpe-frame-visibility), plus a real focus gained/lost cycle (proto-ui-tpe-frame-focus)" },
    ...
    .{ .feature = .resource_payload_eviction_contract, .status = .degraded, .evidence = "proto-ui-unit bounded payload cache and RESOURCE_EVICT scene dispatch" },
    ...
    .{ .feature = .atlas_texture_cache_v1, .status = .degraded, .evidence = "sdl3-runtime-bridge-smoke persistent page cache with one upload and four hits; smoke reset clearing wired; production-wide renderer-loss integration pending" },
    ...
    .{ .feature = .runtime_host_registration_contract, .status = .degraded, .evidence = "R7 contract is approved; linkage and terminal registration remain absent" },
    .{ .feature = .runtime_frame_service_mapping, .status = .degraded, .evidence = "proto-ui-unit" },
    .{ .feature = .runtime_terminal_service_v1, .status = .degraded, .evidence = "proto-ui-unit and proto-ui-terminal-service fake-host lifecycle; adapter linkage and Emacs terminal registration pending" },
    .{ .feature = .runtime_host_adapter_selection, .status = .degraded, .evidence = "proto-ui-host-adapter selects the pure-SDL3 candidate; Emacs linkage and runtime remain absent" },
    .{ .feature = .runtime_activation_contract, .status = .degraded, .evidence = "proto-ui-runtime-activation is blocked without linkage or registration" },
    ...
    .{ .feature = .runtime_face_capture_v1, .status = .degraded, .evidence = "runtime bridge face observation/encoding and sdl3-runtime-bridge-smoke; real Emacs redisplay pending" },
    .{ .feature = .runtime_font_capture_v1, .status = .degraded, .evidence = "runtime bridge font observation/encoding, live face-font checks, and sdl3-runtime-bridge-smoke; real font pipeline pending" },
    .{ .feature = .runtime_image_capture_v1, .status = .degraded, .evidence = "runtime bridge bounded RGBA8 observation/encoding and sdl3-runtime-bridge-smoke; full image parity pending" },
