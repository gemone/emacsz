...
pub const feature_descriptors = [_]FeatureDescriptor{
    ...
    .{ .feature = .ime_reverse_wire_v1, .status = .degraded, .evidence = "proto-ui-unit bounded attached/detached/preedit/commit/surrounding/delete/candidate/cancel wire codecs; platform backend and core application pending" },
