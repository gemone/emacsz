...
pub const feature_descriptors = [_]FeatureDescriptor{
    ...
    .{ .feature = .frame_visibility_focus_contract, .status = .degraded, .evidence = "proto-ui-unit; real SDL minimize/restore maps to iconify-frame/make-frame-visible and restores frame-visible-p=t (proto-ui-tpe-frame-visibility)" },
