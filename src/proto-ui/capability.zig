...
pub const feature_descriptors = [_]FeatureDescriptor{
    ...
    .{ .feature = .ime_reverse_wire_v1, .status = .degraded, .evidence = "proto-ui-unit and sdl3-runtime-bridge-smoke bounded attached/detached/preedit/commit/surrounding/delete/candidate/cancel codecs, Scene preedit state, and bounded ASCII preedit overlay; platform backend, commit application, candidates, and Unicode preedit rendering pending" },
