...
pub const feature_descriptors = [_]FeatureDescriptor{
    ...
    .{ .feature = .session_control_v1, .status = .degraded, .evidence = "codecs, proto-ui-unit terminal states, Scene suspend/resume, and sdl3-live-smoke EPXL transport; close/liveness/error transport pending" },
