...
pub const feature_descriptors = [_]FeatureDescriptor{
    ...
    .{ .feature = .ime_reverse_wire_v1, .status = .degraded, .evidence = "proto-ui-unit bounded attached/detached/preedit/commit/surrounding/delete/candidate/cancel codecs and Scene preedit start/update/end state; platform backend, rendering, commit application, and candidates pending" },
