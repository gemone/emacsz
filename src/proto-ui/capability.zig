...
pub const feature_descriptors = [_]FeatureDescriptor{
    ...
    .{ .feature = .atlas_glyph_render_v1, .status = .degraded, .evidence = "sdl3-runtime-bridge-smoke per-frame page texture cache and ASCII atlas-glyph fallback; shaping and persistent atlas pending" },
