...
const ranges = [_]Range{
    ...
    .{ .low = 0x0304, .high = 0x0307, .status = .planned, .domain = .window, .family = "window-state", .note = "zones/face/position payloads pending" },
    ...
    .{ .low = 0x0309, .high = 0x030a, .status = .planned, .domain = .window, .family = "window-interaction", .note = "scroll request and mouse-highlight payloads pending" },
