...
const ranges = [_]Range{
    ...
    .{ .low = 0x0408, .high = 0x040d, .status = .planned, .domain = .render, .family = "render-control", .note = "fringe/divider/damage codecs pending" },
    .{ .low = 0x040e, .high = 0x040e, .status = .implemented_codec, .domain = .render, .family = "flush", .note = "strict present-boundary codec, Scene generation validation, SDL smoke evidence" },
    .{ .low = 0x040f, .high = 0x040f, .status = .implemented_codec, .domain = .render, .family = "render-hint", .note = "strict mode/workload/deadline codec, Scene state, SDL smoke evidence" },
