...
const ranges = [_]Range{
    ...
    .{ .low = 0x0201, .high = 0x0201, .status = .implemented_codec, .domain = .frame, .family = "frame-patch", .note = "exact 40-byte atomic patch for visibility/focus/opacity/decoration/scale with Scene and SDL evidence; title, geometry, monitor, z-order, and complete frame snapshot pending" },
    .{ .low = 0x0202, .high = 0x0202, .status = .planned, .domain = .frame, .family = "frame-snapshot", .note = "complete frame-state snapshot payload pending" },
    ...
    .{ .low = 0x0901, .high = 0x0901, .status = .planned, .domain = .widget, .family = "menu-patch", .note = "incremental menu model patch pending" },
    ...
    .{ .low = 0x0906, .high = 0x092f, .status = .planned, .domain = .widget, .family = "menu-toolbar", .note = "menu hover and tool bar models pending" },
