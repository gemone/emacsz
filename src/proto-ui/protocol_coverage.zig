...
const ranges = [_]Range{
    ...
    .{ .low = 0x020b, .high = 0x020c, .status = .planned, .domain = .frame, .family = "frame-window-state", .note = "fullscreen and maximize payloads pending" },
    ...
    .{ .low = 0x020e, .high = 0x020f, .status = .planned, .domain = .frame, .family = "frame-monitor-scale", .note = "monitor and scale payloads pending" },
