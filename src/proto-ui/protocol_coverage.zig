...
const ranges = [_]Range{
    ...
    .{ .low = 0x0700, .high = 0x0703, .status = .implemented_codec, .domain = .ime, .family = "ime-context-lifecycle", .note = "bounded attach/detach/focus/cursor codecs and Scene owner validation; platform backend pending" },
    .{ .low = 0x0704, .high = 0x0705, .status = .planned, .domain = .ime, .family = "ime-policy", .note = "allowed-input and surrounding-text payloads pending" },
    .{ .low = 0x0706, .high = 0x0706, .status = .implemented_codec, .domain = .ime, .family = "ime-reset", .note = "bounded reset codec and live-context validation" },
    .{ .low = 0x0710, .high = 0x0719, .status = .planned, .domain = .ime, .family = "ime", .note = "composition, commit, surrounding-text, and candidate payloads pending" },
