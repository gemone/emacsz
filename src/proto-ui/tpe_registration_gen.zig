//! Emits the machine-checkable TP2 registration-policy contract.
...
pub fn main(minimal: std.process.Init.Minimal) !void {
    ...
    if (args.next() != null) return error.UnknownGenArgument;

    var manifest: std.ArrayList(u8) = .empty;
    defer manifest.deinit(gpa);
    try proto_ui.tpe_registration.writeManifest(gpa, &manifest);
