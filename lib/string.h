...
#if defined WINDOWSNT && !defined _GL_W32_STRING_H
#define _GL_W32_STRING_H
/* mingw's <string.h> lacks stpcpy; lib/w32/stpcpy.c provides it.  */
extern char *stpcpy (char *dest, const char *src);
/* ... and strsignal; lib/w32/strsignal.c provides it.  */
