...
#if defined _WIN32 && !defined __CYGWIN__ && !defined WINDOWSNT
# include <io.h>
# include <direct.h>
#endif
...
/* Native Windows platforms declare _execl*, _execv* in <process.h>.
   Emacs skips this on WINDOWSNT: src/process.h shadows the system
   header, and src/ms-w32.h declares _getpid/_execvp itself (see the
   "We cannot include system header process.h" comment there).  */
#if defined _WIN32 && !defined __CYGWIN__ && !defined WINDOWSNT
# include <process.h>
#endif
...
# elif defined _WIN32 && !defined __CYGWIN__ && !defined WINDOWSNT
#  if !(defined __cplusplus && defined GNULIB_NAMESPACE)
#   undef access
...
_GL_CXXALIAS_SYS (execvpe, int,
                  (const char *program, char * const *argv, char * const *env));
# endif
# if (defined _WIN32 && !defined __CYGWIN__ && !defined WINDOWSNT) || 1
_GL_CXXALIASWARN (execvpe);
# endif
#endif
